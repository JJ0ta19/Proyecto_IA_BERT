...
import sys
sys.path.insert(0, os.path.join(settings.BASE_DIR, 'neural_code'))
...
MODEL_PATH = os.path.join(settings.BASE_DIR, 'neural_code', 'models', 'bert_classifier.pt')
DATASET_PATH = os.path.join(settings.BASE_DIR, 'dataset', '1_resume_classification', 'training_data.csv')
